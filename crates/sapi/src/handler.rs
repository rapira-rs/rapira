...
use crate::{
    api::{UnaryCall, UnaryReply},
    start::Rapira,
    types::{Context, Frame, GrpcJob, Job, Request, Unit},
};
...
impl RapiraHandle {
    ...
    pub async fn call(&self, req: UnaryCall) -> Result<oneshot::Receiver<UnaryReply>, HandleError> {
